...
// ============ سيرفر HTTP بسيط عشان Render يلقى port مفتوح ============
// (هذا مو له علاقة بالبوت نفسه، فقط عشان Render ما يعتبر الخدمة متوقفة)
...
// ============ تسجيل الأخطاء عشان نعرف سبب أي توقف ============
...
client.on('messageCreate', async message => {
    try {
        ...
        console.error('❗ خطأ أثناء تنفيذ أمر:', err);
    }
});
